...
if (isset($_POST)) {
    ...
    if (empty($errors)) {
        ...
        http://localhost/gestion_compte_user/confirm?id=$userId&token=$token";
...
<div class="content">
    <div class="container">
        ...
        <?php
if (!empty($errors)) {
    echo '<span style="color:white; text-align: center; background-color:#ff6c6c; margin-bottom:10px; font-size:23px;">' . reset($errors) . '</span>';
}
?>
